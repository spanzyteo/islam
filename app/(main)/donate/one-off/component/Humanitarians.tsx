'use client'
import { humanitarians } from '@/app/(main)/data/OneOffData'
...
const Humanitarians = () => {
  ...
  const filteredHumanitarians = humanitarians.filter(
  ...
  return (
    <>
      ...
      <div className="mt-4 flex flex-col items-center justify-center gap-8">
        {filteredHumanitarians.map((item) => (
          <>
            <div
              key={item.id}
