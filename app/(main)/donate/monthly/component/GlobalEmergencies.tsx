...
import { globalEmergencies } from '@/app/(main)/data/donateData'

const GlobalEmergencies = () => {
  ...
  const filteredGlobalEmergencies = globalEmergencies.filter(
  ...
  return (
    <>
      ...
      <div className="mt-4 flex flex-col items-center justify-center gap-8">
        {filteredGlobalEmergencies.map((item) => (
          <>
            <div
              key={item.id}
...
export default GlobalEmergencies
