...
const SecondaryFooter = () => {
  return (
    <div className="mt-20 flex lg:flex-row flex-col bg-[#305176]">
      <div className="flex lg:flex-row flex-col lg:mx-auto gap-16">
        <div className="mt-8 flex flex-col ml-4 lg:ml-0 pb-4">
          ...
          <div className="flex flex-col mt-8 gap-1">
            ...
            <h1 className="text-white text-[12px]">Complaints and concerns</h1>
            <h1 className="text-white text-[12px]">Media enquiries</h1>
            <h1 className="text-white text-[12px]">Media enquiries</h1>
            <h1 className="text-white text-[12px]">Privacy statement</h1>
          </div>
          <div className="flex flex-col mt-8 gap-1">
            <h1 className="text-white text-[12px]">Islamic Relief Worldwide</h1>
            <h1 className="text-white text-[12px]">19 Rea St South Digbeth</h1>
        ...
        <div className="lg:mt-20 flex flex-row ml-4 lg:ml-0 lg:gap-32 gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h1 className="text-white text-[12px]">Empowering communities</h1>
              <h1 className="text-white text-[12px]">Campaigning for change</h1>
              <h1 className="text-white text-[12px]">
            ...
            <h1 className="text-[#F29F05] font-semibold mt-8">Work with us</h1>
            <div className="flex flex-col gap-2">
              <h1 className="text-white text-[12px]">Current opportunities</h1>
              <h1 className="text-white text-[12px]">
        ...
        <div className="bg-[#F29F05] lg:w-[346px] w-[100%] lg:mt-[-1.5rem]">
          <div className="mt-16 flex flex-col ml-4 lg:ml-8">
            <h1 className="text-3xl text-[#305176] font-semibold">EMERGENCY</h1>
