  ...
  return (
    <div className="mt-20">
      ...
      <div className="mt-20 flex bg-[#305473] pb-20">
        <div className="bg-[#375B7D] flex flex-col w-[30%] border-r border-r-[#F29F05]">
        ...
        <div className="w-[70%] flex lg:flex-row flex-col lg:ml-10 ml-2 mt-20">
          <div className=" flex flex-col">
            <div>
              ...
              <h1 className="text-white text-xl mt-4 lg:w-[100%] w-[250px]">
            ...
            <div className="mt-20">
              ...
              <h1 className="text-white text-xl mt-4 lg:w-[450px] w-[250px]">
